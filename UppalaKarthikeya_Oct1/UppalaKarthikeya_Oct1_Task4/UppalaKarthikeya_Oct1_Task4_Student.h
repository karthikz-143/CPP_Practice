#ifndef UPPALAKARTHIKEYA_OCT1_TASK4_STUDENT_H
#define UPPALAKARTHIKEYA_OCT1_TASK4_STUDENT_H
...
public:
    GraduateStudent(const std::string& n, const std::string& id, const std::string& dept,
...
{
public:
    MastersStudent(const std::string& n, const std::string& id, const std::string& dept,
                   const std::string& adv);
    void displayInfo() const override;
    std::string getLevel() const override;
};
